...
namespace MyHostel_Admin.Pages.Admin_Page.NearbyFacilities
{
    public class IndexModel : PageModel
    {
        ...
        public PaginatedList<NearbyFacility> NearbyFacility { get; set; }
        ...
        public async Task<IActionResult> OnGetAsync(string currentFilter, string searchString, int? pageIndex)
        {
            ...
            IQueryable<NearbyFacility> genresIQ = from s in context.NearbyFacilities
                                                  .Include(p => p.Ultility)
                                                 .Include(p => p.Hostel)
                                                  select s;
